...
const enrolledCoursValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        offeredCourse: zod_1.z.string()
    })
});
const updateEnrolledCoursValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
...
exports.EnrolledCourseValidations = {
    enrolledCoursValidationSchema,
    updateEnrolledCoursValidationSchema
};
