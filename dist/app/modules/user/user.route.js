...
router.post('/create-student', (0, auth_1.default)(user_constant_1.USER_ROLE.admin), (0, validateRequest_1.default)(student_validaton_schema_1.StudentValidations.createStudentValidatoinSchema), user_controller_1.UserController.createStudent);
